...
import subprocess, os, re, json, shutil, argparse
...
def parse_packages_json(query: str, json_text: str) -> list[PackageInfo]:
    ...
    for rev_id in revs.keys():
        ...
        for package_id in packages.keys():
            ...
            out.append( PackageInfo(query.name, query.version, rev_id, package_id, settings, options) )
    return out
...
def main():
    ...
    for query in package_queries:
        ...
        copy_subdirs(install_path, package_path, ['include', 'lib', 'bin'])

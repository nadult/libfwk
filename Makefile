...
SHARED_SRC=base backtrace filesystem filesystem_linux filesystem_windows input profiler stream xml xml_conversions \
		   ...
		   gfx/opengl gfx/texture gfx/texture_format gfx/texture_tga gfx/model gfx/mesh gfx/tet_mesh gfx/tet_gen gfx/half_mesh gfx/mesh_indices gfx/mesh_buffers gfx/mesh_constructor \

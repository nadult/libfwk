...
SHARED_SRC=vector filesystem filesystem_linux profiler cstring \
		   sys_base sys/error sys/assert sys/memory sys/backtrace sys/rollback sys/stream sys/xml sys/input \
		   ...
		   gfx/material gfx/matrix_stack gfx/opengl gfx/model gfx/draw_call gfx/program_binder gfx/pose \

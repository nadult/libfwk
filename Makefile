...
SHARED_SRC=vector filesystem filesystem_linux input profiler cstring \
		   sys_base sys/error sys/assert sys/memory sys/backtrace sys/rollback sys/stream sys/xml \

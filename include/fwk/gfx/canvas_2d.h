...
// - Wizualizacja intów
// -  mo¿liwoœæ przechowywania listy obiektów (zeby nie trzeba bylo ich w glupi sposob przekazywac
//    w investigatorze)
// - skalowanie ?

// TODO: voronoi vis

// Zmergowanie Renderer2D, Visualizer2D & Viusalizer3D w jedno
// ma³y stan z funkcjami:
// setPointSize, setMaterial, setMatrix (dziedziczy z MatrixStack
// setViewport
// linie dodawane jako quady odpowiednio skierowane
//
class Canvas2D {
  public:

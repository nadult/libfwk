...
DEFINE_ENUM(TextureFormatId, rgba, bgra, rgba_f16, rgba_f32, rgb, rgb_f16, rgb_f32, r32i, r32ui, r8,
			rg8, dxt1, dxt3, dxt5, depth16, depth24, depth32, depth32f, depth_stencil);
